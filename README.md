...
* [Helper Methods](#helper-methods)
  ...
  * [Typesafe CSS Selector](#typesafe-css-selector)
...
Finally your template class needs to implement `IsElement<E extends HTMLElement>`. The generated code implements the method `E get()` and returns the selected root element of your HTML template. 
