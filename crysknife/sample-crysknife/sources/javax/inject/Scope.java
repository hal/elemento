 ...
 *
 * <p>
 * In the following example, the scope annotation {@code @Singleton} ensures that we only have one
 * Log instance:
 *
 * <pre>
 *   &#064;Singleton
 ...
 * inheritance.</li>
 * <li>may have restricted usage if annotated with {@code @Target}. While this specification covers
 * applying scopes to classes only, some injector configurations might use scope annotations in
 * other places (on factory method results for example).</li>
 * </ul>
 *
 * <p>
 * For example:
 ...
 *
 * <p>
 * Annotating scope annotations with {@code @Scope} helps the injector detect the case where a
