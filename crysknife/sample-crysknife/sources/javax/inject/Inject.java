 ...
 * Provider&lt;A>} or {@code
 * Provider<B>} instead of {@code A} or {@code B} respectively. Calling {@link Provider#get() get()}
 * on the provider directly from the constructor or method it was injected into defeats the
 * provider's ability to break up circular dependencies. In the case of method or field injection,
 * scoping one of the dependencies (using {@linkplain Singleton singleton scope}, for example) may
 * also enable a valid circular relationship.
 *
