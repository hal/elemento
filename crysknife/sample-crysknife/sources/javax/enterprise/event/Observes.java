 ...
 *
 * <p>
 * An observer method is a non-abstract method of a managed bean class or session bean class (or of
 * an extension). An observer method may be either static or non-static. If the bean is a session
 * bean, the observer method must be either a business method of the EJB or a static method of the
 * bean class.
 * </p>
 *
 * <p>
 * Each observer method must have exactly one event parameter, of the same type as the event type it
 * observes. Event qualifiers may be declared by annotating the event parameter. When searching for
 * observer methods for an event, the container considers the type and qualifiers of the event
 * parameter.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * In addition to the event parameter, observer methods may declare additional parameters, which may
 * declare qualifiers. These additional parameters are injection points.
 * </p>
 *
 * <pre>
