...
public @interface NormalScope {
   ...
   *
   * <p>
   * A bean is called passivation capable if the container is able to temporarily transfer the state
   * of any idle instance to secondary storage. A passivating scope requires that beans with the
   * scope are passivation capable.
   * </p>
   *
