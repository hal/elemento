 ...
 *
 * <p>
 * Beans declared with scope <tt>@Dependent</tt> behave differently to beans with other built-in
 * scope types. When a bean is declared to have scope <tt>@Dependent</tt>:
 * </p>
 *
 * <ul>
 ...
 * bound to the lifecycle of the newly created object.</li>
 ...
 * a single evaluation of the EL expression. It is reused if the bean EL name appears multiple times
 * in the EL expression, but is never reused when the EL expression is evaluated again, or when
 * another EL expression is evaluated.</li>
 * <li>Any instance of the bean that receives a producer method, producer field, disposer method or
 * observer method invocation exists to service that invocation only.</li>
 * <li>Any instance of the bean injected into method parameters of a disposer method or observer
 * method exists to service the method invocation only.</li>
 * </ul>
 *
 * <p>
 ...
 *
 * <p>
 * Many instances of beans with scope <tt>@Dependent</tt> belong to some other bean or Java EE
 ...
 * decorate.</li>
 * <li>An instance of a bean with scope <tt>@Dependent</tt> injected into a field, bean constructor
 * or initializer method is a dependent object of the bean or Java EE component class instance into
 * which it was injected.</li>
 * <li>An instance of a bean with scope <tt>@Dependent</tt> injected into a producer method is a
 * dependent object of the producer method bean instance that is being produced.</li>
 ...
 * injection, the container destroys all its dependent objects, after the <tt>@PreDestroy</tt>
 * callback completes and after the servlet <tt>destroy()</tt> method is called.
 * </p>
 *
 * @author Gavin King
 * @author Pete Muir
