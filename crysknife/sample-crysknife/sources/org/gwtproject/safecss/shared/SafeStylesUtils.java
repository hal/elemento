...
public final class SafeStylesUtils {
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted name and a trusted value, i.e., without
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted string, i.e., without escaping the
   * string. No checks are performed. The calling code should be carefully reviewed to ensure the
   * argument meets the {@link SafeStyles} contract.
   *
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted background color, i.e., without
   * escaping the value. No checks are performed. The calling code should be carefully reviewed to
   * ensure the argument will satisfy the {@link SafeStyles} contract when they are composed into
   * the form: "&lt;name&gt;:&lt;value&gt;;".
   *
   * <p>{@link SafeStyles} may never contain literal angle brackets. Otherwise, it could be unsafe
   * to place a {@link SafeStyles} into a &lt;style&gt; tag (where it can't be HTML escaped). For
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted background image, i.e., without
   * escaping the value. No checks are performed. The calling code should be carefully reviewed to
   * ensure the argument will satisfy the {@link SafeStyles} contract when they are composed into
   * the form: "&lt;name&gt;:&lt;value&gt;;".
   *
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted border color, i.e., without escaping
   * the value. No checks are performed. The calling code should be carefully reviewed to ensure the
   * argument will satisfy the {@link SafeStyles} contract when they are composed into the form:
   * "&lt;name&gt;:&lt;value&gt;;".
   *
   * <p>{@link SafeStyles} may never contain literal angle brackets. Otherwise, it could be unsafe
   * to place a {@link SafeStyles} into a &lt;style&gt; tag (where it can't be HTML escaped). For
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted font color, i.e., without escaping the
   * value. No checks are performed. The calling code should be carefully reviewed to ensure the
   * argument will satisfy the {@link SafeStyles} contract when they are composed into the form:
   * "&lt;name&gt;:&lt;value&gt;;".
   *
   * <p>{@link SafeStyles} may never contain literal angle brackets. Otherwise, it could be unsafe
  ...
  /**
   * Returns a {@link SafeStyles} constructed from a trusted outline color, i.e., without escaping
   * the value. No checks are performed. The calling code should be carefully reviewed to ensure the
   * argument will satisfy the {@link SafeStyles} contract when they are composed into the form:
   * "&lt;name&gt;:&lt;value&gt;;".
   *
  ...
  /**
   * Verify that the basic constraints of a {@link SafeStyles} are met. This method is not a
   * guarantee that the specified css is safe for use in a CSS style attribute. It is a minimal set
   * of assertions to check for common errors.
   *
  ...
  static void verifySafeStylesConstraints(String styles) {
    ...
    assert ((styles.trim().length() == 0) || styles.endsWith(";"))
        : "Invalid CSS Property: '"
            + styles
            + "'. CSS properties must be an empty string or end with a semi-colon (;).";
    assert !styles.contains("<") && !styles.contains(">")
        : "Invalid CSS Property: '" + styles + "'. CSS should not contain brackets (< or >).";
  }
}
