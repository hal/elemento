...
public interface InputBuilder extends ElementBuilderBase<InputBuilder> {
  ...
  /**
   * Set the state of the form control to <code>true</code> when type attribute of the element has
   * the value "radio" or "checkbox".
   */
  InputBuilder checked();

  /**
   * Set the default state of the form control to <code>true</code> when type attribute of the
   * element has the value "radio" or "checkbox".
   *
   * @see <a
