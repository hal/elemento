...
public interface LinkBuilder extends ElementBuilderBase<LinkBuilder> {
  ...
  /**
   * Disable the link. This is currently only used for style sheet links, and may be used to
   * deactivate style sheets.
   */
   ...
   *
   * <p>The @IsTrustedResourceUri is added conservatively in case href points to a stylesheet.
   *
