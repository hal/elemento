...
public interface IFrameBuilder extends ElementBuilderBase<IFrameBuilder> {
   ...
   *
   * <p>Appending children or content directly to an iframe isn't supported. You must use the src
   * attribute to specify the url of the content to load, or wait until the document is loaded.
   *
