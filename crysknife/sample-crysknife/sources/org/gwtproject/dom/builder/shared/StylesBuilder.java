...
public interface StylesBuilder {
  ...
  /**
   * Sets the "background-color" style property to the specified color string. Does not check or
   * escape the color string. The calling code should be carefully reviewed to ensure that the
   * provided color string won't cause a security issue if included in a style attribute.
   *
   * <p>For details and constraints, see {@link org.gwtproject.safecss.shared.SafeStyles}.
   *
   * @return this {@link StylesBuilder}
   */
  ...
  /**
   * Sets the "background-image" style property to the specified value. Does not check or escape the
   * value. The calling code should be carefully reviewed to ensure that the provided value string
   * won't cause a security issue if included in a style attribute.
   *
   * <p>For details and constraints, see {@link org.gwtproject.safecss.shared.SafeStyles}.
   *
   * @return this {@link StylesBuilder}
  ...
  /**
   * Sets the "border-color" style property to the specified color string. Does not check or escape
   * the color string. The calling code should be carefully reviewed to ensure that the provided
   * color string won't cause a security issue if included in a style attribute.
   *
   * <p>For details and constraints, see {@link org.gwtproject.safecss.shared.SafeStyles}.
   *
   * @return this {@link StylesBuilder}
  ...
  /**
   * Sets the "color" style property, which controls font color, to the specified color string. Does
   * not check or escape the color string. The calling code should be carefully reviewed to ensure
  ...
  /**
   * Sets the "outline-color" style property to the specified color string. Does not check or escape
   * the color string. The calling code should be carefully reviewed to ensure that the provided
   * color string won't cause a security issue if included in a style attribute.
   *
   * <p>For details and constraints, see {@link org.gwtproject.safecss.shared.SafeStyles}.
