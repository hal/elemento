...
import static org.elemento.Elements.htmlElements;
...
final class BodyObserver {
    ...
    /**
     * Checks if the observer has already been started, if not it will start it. Then register and callback when the
